...
Администратор отправляет заказ в виде требований клиента помощнику пекаря, а тот подтверждает получение заказа.
...
Заказ является записью Базы данных, которая относится к Информационным потокам, и состоит из: Требований, Отзыва клиента и Хлеба.
